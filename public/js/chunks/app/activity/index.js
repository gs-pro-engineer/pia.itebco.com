(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app/activity/index"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      fields: [//date time, user, log name, action
      {
        key: 'createdAt',
  ...
  methods: {
    getAgent: function getAgent(agentString, key) {
      var asString = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
      var parserObj = new ua_parser_js__WEBPACK_IMPORTED_MODULE_2__["UAParser"](agentString);
      parserObj = parserObj.getResult();
      return asString ? "".concat(parserObj[key]['name'], " (").concat(parserObj[key]['version'], ")") : parserObj[key];
    }
  },
            ...
            _c("date-between", {
              attrs: {
                label: _vm.$t("global.between", {
                  attribute: _vm.$t("activity.activities")
                }),
                        ...
                        scopedSlots: _vm._u(
                          [
                            ...
                            },
                            {
                              ...
                              fn: function(row) {
                                return [
                                  row.item.properties && row.item.properties.ip
                                    ? _c("span", [
                                        _vm._v(_vm._s(row.item.properties.ip))
                                      ])
                                    : _c(
                                        "span",
                                        { staticClass: "text-muted" },
...
//# sourceMappingURL=index.js.map?id=4cbd1f91281a02d90912