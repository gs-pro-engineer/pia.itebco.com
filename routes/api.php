...
Route::group(['middleware' => ['auth:sanctum', '2fa', 'under_maintenance']], function () {
    ...
    Route::namespace('Config')->prefix('config')->group(function () {
        ...
        Route::post('system/google_api_key_json/start', 'ConfigController@startImport');
        Route::delete('system/google_api_key_json/start/{fileName}', 'ConfigController@removeFile');
        Route::get('translator', 'ConfigController@translator');
        Route::post('azure_api_key', 'ConfigController@saveAzureApiKey');
        Route::post('google_api_key', 'ConfigController@saveGoogleApiKey');
